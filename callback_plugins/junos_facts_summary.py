...
## https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/callback/__init__.py
  ...
  def v2_runner_on_ok(self, result):
    ...
    if junos_has_2RE:
        self._display.display('Device has 2 Routing engines. Please find details below:')
    else:
        self._display.display('Device has only 1 Routing engine. Please find details below:')
    ...
    if 'RE0' in junos_dict:
        self._display.display('\tRouting Engine RE0:')
    ...
    if 'RE1' in junos_dict and junos_has_2RE:
        self._display.display('\tRouting Engine RE1:')
